...
export const Courses: React.FC<CoursesProps> = ({ selectedCourse, onStartQuiz }) => {
  const courseContent = {
    'renewable-energy': {
      ...
      modules: [
        {
          ...
          duration: '15 min',
          completed: false,
          content: 'Learn about different types of renewable energy sources and their importance for our planet.'
        },
        {
          id: 2,
          ...
          duration: '20 min',
          completed: false,
          content: 'Discover how solar panels work and their environmental benefits.'
        },
        {
          id: 3,
        ...
        questions: [
          {
            ...
            correct: 1,
            explanation: 'Wind energy harnesses the kinetic energy of moving air to generate electricity through wind turbines.'
          },
          {
            question: 'What percentage of global electricity comes from renewable sources as of 2023?',
            options: ['15%', '25%', '30%', '45%'],
            correct: 2,
            explanation: 'Renewable energy sources now account for approximately 30% of global electricity generation.'
          },
          {
            question: 'Solar panels convert sunlight into electricity through which process?',
            options: ['Photosynthesis', 'Photovoltaic effect', 'Nuclear fusion', 'Combustion'],
            correct: 1,
            explanation: 'The photovoltaic effect allows solar cells to convert photons from sunlight directly into electrical energy.'
          }
        ]
      }
    },
        ...
        questions: [
          {
            ...
            correct: 1,
            explanation: 'Approximately 8 million tons of plastic waste enters our oceans every year.'
          },
          {
            question: 'What percentage of Earth\'s oxygen is produced by ocean phytoplankton?',
            options: ['25%', '50%', '70%', '90%'],
            correct: 2,
            explanation: 'Ocean phytoplankton produces about 70% of the oxygen we breathe.'
          }
        ]
      }
    },
        ...
        questions: [
          {
            ...
            correct: 1,
            explanation: 'Air travel typically has the highest carbon footprint per mile traveled.'
          }
        ]
      }
    }
  ...
  const course = courseContent[selectedCourse?.id] || courseContent['renewable-energy'];
    ...
    <div className="max-w-4xl mx-auto p-6">
            ...
            <div>
              ...
              <div className="flex items-center space-x-6 text-sm text-gray-500">
                <div className="flex items-center space-x-1">
                  ...
                  <span>{course.modules.reduce((acc, module) => acc + parseInt(module.duration), 0)} min total</span>
                </div>
                <div className="flex items-center space-x-1">
      ...
      <div className="space-y-6">
        ...
        {course.modules.map((module, index) => (
          <div key={module.id} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <div className="flex items-center space-x-3 mb-3">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${
                    ...
                    {module.completed ? <CheckCircle className="h-5 w-5" /> : index + 1}
                  </div>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-green-600 rounded-xl p-6 text-white">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="opacity-90 mb-4">Test your knowledge and earn XP!</p>
